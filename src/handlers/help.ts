...
const HELP =
  "Use Submit a lead to share your contact details and property needs.\n\n" +
  "You’ll review everything before it is sent. Use /start for the menu. The agent can use /admin for the lead inbox.";
